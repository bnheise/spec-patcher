...
pub fn picklist_to_enum(picklist: ListTypeDefinition) -> Result<[(String, Schema); 3], PatchError> {
    let erc = picklist
        .external_reference_code
        .as_ref()
        .ok_or(PatchError::MissingField("externalReferenceCode"))?
...
fn build_erc_enum(
    ...
    erc: &str,
) -> Result<(String, Schema), PatchError> {
