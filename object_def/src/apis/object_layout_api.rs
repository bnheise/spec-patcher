...
pub async fn delete_object_layout(
...
pub async fn delete_object_layout_batch(
    configuration: &configuration::Configuration,
...
pub async fn get_object_definition_by_external_reference_code_object_layouts_page(
    configuration: &configuration::Configuration,
...
pub async fn get_object_definition_object_layouts_page(
    configuration: &configuration::Configuration,
...
pub async fn post_object_definition_by_external_reference_code_object_layout(
    configuration: &configuration::Configuration,
    external_reference_code: &str,
...
pub async fn post_object_definition_object_layout(
    configuration: &configuration::Configuration,
    object_definition_id: &str,
    object_layout: Option<crate::models::ObjectLayout>,
...
pub async fn post_object_definition_object_layout_batch(
    configuration: &configuration::Configuration,
    object_definition_id: &str,
    callback_url: Option<&str>,
    body: Option<serde_json::Value>,
...
pub async fn post_object_definition_object_layouts_page_export_batch(
    configuration: &configuration::Configuration,
    object_definition_id: &str,
    search: Option<&str>,
    sort: Option<&str>,
...
) -> Result<(), Error<PostObjectDefinitionObjectLayoutsPageExportBatchError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v1.0/object-definitions/{objectDefinitionId}/object-layouts/export-batch",
        local_var_configuration.base_path,
        objectDefinitionId = crate::apis::urlencode(object_definition_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostObjectDefinitionObjectLayoutsPageExportBatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn put_object_layout(
    configuration: &configuration::Configuration,
    object_layout_id: &str,
    object_layout: Option<crate::models::ObjectLayout>,
...
pub async fn put_object_layout_batch(
    configuration: &configuration::Configuration,
    callback_url: Option<&str>,
    body: Option<serde_json::Value>,
