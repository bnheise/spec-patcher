...
pub async fn delete_object_field(
...
pub async fn delete_object_field_batch(
    configuration: &configuration::Configuration,
...
pub async fn get_object_definition_by_external_reference_code_object_fields_page(
    configuration: &configuration::Configuration,
...
pub async fn get_object_definition_object_fields_page(
    configuration: &configuration::Configuration,
...
pub async fn patch_object_field(
    configuration: &configuration::Configuration,
    object_field_id: &str,
...
pub async fn post_object_definition_by_external_reference_code_object_field(
    configuration: &configuration::Configuration,
    external_reference_code: &str,
    object_field: Option<crate::models::ObjectField>,
) -> Result<
...
pub async fn post_object_definition_object_field(
    configuration: &configuration::Configuration,
    object_definition_id: &str,
    object_field: Option<crate::models::ObjectField>,
...
pub async fn post_object_definition_object_field_batch(
    configuration: &configuration::Configuration,
    object_definition_id: &str,
    callback_url: Option<&str>,
    body: Option<serde_json::Value>,
...
pub async fn post_object_definition_object_fields_page_export_batch(
    ...
    let local_var_uri_str = format!(
        "{}/v1.0/object-definitions/{objectDefinitionId}/object-fields/export-batch",
        local_var_configuration.base_path,
        objectDefinitionId = crate::apis::urlencode(object_definition_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostObjectDefinitionObjectFieldsPageExportBatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn put_object_field_batch(
    configuration: &configuration::Configuration,
    callback_url: Option<&str>,
    body: Option<serde_json::Value>,
