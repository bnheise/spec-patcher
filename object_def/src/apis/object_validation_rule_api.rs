...
pub async fn delete_object_validation_rule(
...
pub async fn delete_object_validation_rule_batch(
    configuration: &configuration::Configuration,
...
pub async fn get_object_definition_by_external_reference_code_object_validation_rules_page(
    configuration: &configuration::Configuration,
...
pub async fn get_object_definition_object_validation_rules_page(
    configuration: &configuration::Configuration,
...
pub async fn get_object_validation_rule(
    configuration: &configuration::Configuration,
    object_validation_rule_id: &str,
...
pub async fn patch_object_validation_rule(
    configuration: &configuration::Configuration,
    object_validation_rule_id: &str,
...
pub async fn post_object_definition_by_external_reference_code_object_validation_rule(
    configuration: &configuration::Configuration,
    external_reference_code: &str,
    object_validation_rule: Option<crate::models::ObjectValidationRule>,
) -> Result<
...
pub async fn post_object_definition_object_validation_rule(
    configuration: &configuration::Configuration,
    object_definition_id: &str,
    object_validation_rule: Option<crate::models::ObjectValidationRule>,
...
pub async fn post_object_definition_object_validation_rule_batch(
    configuration: &configuration::Configuration,
    object_definition_id: &str,
    callback_url: Option<&str>,
    body: Option<serde_json::Value>,
...
pub async fn post_object_definition_object_validation_rules_page_export_batch(
    configuration: &configuration::Configuration,
    object_definition_id: &str,
    search: Option<&str>,
    sort: Option<&str>,
...
) -> Result<(), Error<PostObjectDefinitionObjectValidationRulesPageExportBatchError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!(
        "{}/v1.0/object-definitions/{objectDefinitionId}/object-validation-rules/export-batch",
        local_var_configuration.base_path,
        objectDefinitionId = crate::apis::urlencode(object_definition_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            PostObjectDefinitionObjectValidationRulesPageExportBatchError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn put_object_validation_rule(
    configuration: &configuration::Configuration,
    object_validation_rule_id: &str,
    object_validation_rule: Option<crate::models::ObjectValidationRule>,
...
pub async fn put_object_validation_rule_batch(
    configuration: &configuration::Configuration,
    callback_url: Option<&str>,
    body: Option<serde_json::Value>,
