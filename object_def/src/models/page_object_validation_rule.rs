...
pub struct PageObjectValidationRule {
    ...
    pub items: Option<Vec<crate::models::ObjectValidationRule>>,
...
impl PageObjectValidationRule {
    pub fn new() -> PageObjectValidationRule {
